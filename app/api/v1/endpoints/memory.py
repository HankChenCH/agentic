...
def memory_graph(
    ...
    return Response.success(graph_service.graph_snapshot(user_id=principal.user_id, at_iso=at, limit=limit)).to_dict()
...
def create_statement(
    ...
    return Response.success(admin_service.add_statement(principal.user_id, request)).to_dict()
...
def correct_statement(
    ...
    return Response.success(admin_service.correct_statement(principal.user_id, statement_ref, request)).to_dict()
...
def archive_statement(
    ...
    return Response.success(admin_service.archive_statement(principal.user_id, statement_ref)).to_dict()
...
def update_entity(
    ...
    return Response.success(admin_service.update_entity(principal.user_id, entity_ref, request)).to_dict()
...
def merge_entity(
    ...
    return Response.success(admin_service.merge_entity(principal.user_id, entity_ref, request)).to_dict()
...
def split_entity(
    ...
    return Response.success(admin_service.split_entity(principal.user_id, entity_ref, request)).to_dict()
...
def delete_entity(
    ...
    return Response.success(admin_service.delete_entity(principal.user_id, entity_ref)).to_dict()
...
def update_episode(
    ...
    return Response.success(admin_service.update_episode(principal.user_id, episode_ref, request)).to_dict()
...
def delete_episode(
    ...
    return Response.success(admin_service.delete_episode(principal.user_id, episode_ref)).to_dict()
...
def purge_preview(
    ...
    return Response.success(admin_service.purge_preview(principal.user_id, request)).to_dict()
...
def purge_memory(
    ...
    return Response.success(admin_service.purge_memory(principal.user_id, request)).to_dict()
...
def export_memory(
    ...
    payload = json.dumps(admin_service.export_memory(principal.user_id), ensure_ascii=False)
    return RawResponse(
        content=payload,
...
def reset_memory(
    ...
    return Response.success(admin_service.reset_all_memory(principal.user_id, request)).to_dict()
...
def update_episode_link(
    ...
    return Response.success(admin_service.update_episode_link(principal.user_id, link_ref, request)).to_dict()
