...
export const MemoryGraphLegend: FC = () => (
  <div className="absolute bottom-4 left-4 z-10 flex max-w-[420px] flex-wrap items-center gap-x-3 gap-y-1 rounded-lg border border-border/70 bg-card/90 px-3 py-2 text-[11px] text-muted-foreground shadow-card backdrop-blur">
